...
alter table "public"."applications" drop column "eliminated" cascade;
...
alter table "public"."rating_rounds" drop constraint "rating_start_in_future";
alter table "public"."rating_rounds" add constraint "rating_ends_in_future" check (end_at > created_at);

alter table "public"."rating_rounds" drop constraint "rating_starts_before_end";

alter table "public"."rating_rounds" alter column "start_at" set default now();

alter table "public"."messages"
  add constraint "messages_id_fkey"
  foreign key ("id")
  references "public"."ratings"
  ("message_id") on update cascade on delete cascade;
...
alter table "public"."ratings"
  add constraint "ratings_created_by_fkey"
