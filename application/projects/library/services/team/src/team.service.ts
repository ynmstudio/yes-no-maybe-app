...
import { ModalService } from '@library/components/modal';
import type {
  DeleteUpdateComponent as DeleteUpdateComponentType,
  EditUpdateComponent as EditUpdateComponentType,
  NewUpdateComponent as NewUpdateComponentType,
  ConfirmWinnerComponent as ConfirmWinnerComponentType
} from '@library/components/modal';
import {
  GetAllEditionsGQL,
